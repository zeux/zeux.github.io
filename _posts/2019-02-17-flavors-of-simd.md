...
I'm not sure how many of these optimizations will end up in `meshoptimizer` master - after all, this was mostly an experiment to see how much it's possible to push the hardware without drastically changing any algorithms involved. Hopefully this was informative and can give you ideas to optimize your code.
