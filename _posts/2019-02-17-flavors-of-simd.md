...
For our benchmark, we will be simplifying a 6M triangle "Thai Buddha" model, reducing it to 1% of the triangle count. We will use one compiler, Microsoft Visual Studio 2019, to target x64 architecture.
