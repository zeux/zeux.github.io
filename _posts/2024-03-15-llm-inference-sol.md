...
> Mixture of Experts models like Mixtral have slightly different scaling characteristics: batching initially only increases the bandwidth utilization, but once the expert utilization becomes significant the inference becomes increasingly ALU bound. Detailed analysis left for another time!
